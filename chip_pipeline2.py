...
def genome_dict(machine = "scg3",  genome = 'mm9'): 
    ...
    elif machine == 'cac' and genome == 'mm9':
        genome_file = {
            'bowtie2': '/global/project/hpcg2073/genomes/mm9/Bowtie2Index/mm9',
            'chr_size': '/global/project/hpcg2073/genomes/mm9/annotation/mm9_chr_size_noran.txt',
            'genome_chr': '/global/project/hpcg2073/genomes/mm9/Chromosomes',
            'genome': '/global/project/hpcg2073/genomes/mm9/WholeGenomeFasta',
            'mappability': '/global/project/hpcg2073/genomes/mm9/mappability/wgEncodeCrgMapabilityAlign50mer.bigWig'
        }
    else:
...
def bash_header(machine = 'scg3'):
    if machine == 'scg3':
        ...
        cmd = '#SBATCH --job-name=chip_seq\n'
        cmd += '#SBATCH --ntasks=1\n'
        cmd += '#SBATCH --cpus-per-task=2\n'
        cmd += '#SBATCH --mem=10G\n'
        cmd += '#SBATCH --time=24:00:00\n'
        cmd += '#SBATCH --output=%x_%j.out\n'
        cmd += '#SBATCH --error=%x_%j.err\n'
...
def main():
    ...
    parser.add_argument('-c','--machine', help='speficies the paths for genome.fa, chr sizes and bowtie2 index for a given system', default='scg3', choices=['scg3','cho_oro','cac'], required=False)
    ...
    # set wiggler_src path based on machine
    if machine == 'scg3':
        exe_dict['wiggler_src'] = '/srv/gsfs0/projects/cho/programs/align2rawsignal/src'
    elif machine == 'cho_oro':
        exe_dict['wiggler_src'] = '/srv/gsfs0/projects/cho/programs/align2rawsignal/src'
    elif machine == 'cac':
        # TODO: Update this path to where align2rawsignal is installed on CAC
        exe_dict['wiggler_src'] = '/global/project/hpcg2073/programs/align2rawsignal/src'
    #print exe_dict
