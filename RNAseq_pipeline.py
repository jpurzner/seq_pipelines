...
def genome_dict(machine = "scg3",  genome = 'mm9'): 
    ...
    if machine == 'scg3' and genome == 'mm9':
        genome_file = {
           'bowtie2': '/srv/gsfs0/projects/cho/bowtie2_indexes/mm9',
           ...
           'RSEM': '/srv/gsfs0/projects/cho/genomes/mm9/RSEM/RSEM',
           'gencode': '/srv/gsfs0/projects/cho/annotation/gencode.vM1.annotation.gtf'
        }
